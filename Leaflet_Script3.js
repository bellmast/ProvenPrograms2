...
:
FT,
"<div><div style='border: 1px solid black; background-color: teal; opacity: 1; border-radius: 50%; width: 13px; height: 13px;float:left; margin-top:-16px; margin-left: 20px'><span style='font-size: 12px;'>&nbsp&nbsp&nbsp&nbsp&nbspiStart</span></div>"
:
IS,
