...
myColor = "crimson"
var CSG = L.geoJson(cSG, {onEachFeature: function(feature, layer) { return layer.bindPopup(feature.properties.Attendee+\n+feature.properties.City)}, pointToLayer: pointToLayer})
myColor = "orange"
...
:
GAN,
"<div><div style='border: 1px solid black; background-color: crimson; opacity: 1; border-radius: 50%; width: 13px; height: 13px;float:left; margin-top:-16px; margin-left: 20px'><span style='font-size: 12px;'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCSG</span></div>"
:
CSG,
...
function runProgram() {
	map = L.mapbox.map('map', 'bellmast.map-cvywgjou', {layers: [SL, MF, SW, IH, FT, IS, GAN, CSG, MC]}).setView([39.0997, -94.5783], 5);
